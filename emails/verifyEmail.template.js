module.exports = function verifyEmailTemplate({
  ...
  const emailTexts = {
    en: {
      ...
      description: 'Welcome to Mushrif! Please verify your email address to complete your registration and unlock all features.',
      buttonText: 'Verify Email',
      fallbackText: "If the button doesn't work, copy and paste this link into your browser:",
      warningText: '⚠️ This verification link will expire in 24 hours. If you didn\'t create this account, you can safely ignore this email.',
      copyright: '© {{year}} Mushrif. All rights reserved.'
    },
    ar: {
      title: 'تحقق من عنوان بريدك الإلكتروني',
      description: 'أهلاً وسهلاً في مشرف! يرجى التحقق من عنوان بريدك الإلكتروني لإكمال تسجيلك وفتح جميع الميزات.',
      buttonText: 'تحقق من البريد الإلكتروني',
      fallbackText: 'إذا لم يعمل الزر، انسخ والصق هذا الرابط في متصفحك:',
      warningText: '⚠️ سينتهي صلاحية رابط التحقق هذا خلال 24 ساعة. إذا لم تنشئ هذا الحساب، فيمكنك تجاهل هذا البريد الإلكتروني بأمان.',
      copyright: '© {{year}} مشرف. جميع الحقوق محفوظة.'
    },
    fr: {
      title: 'Vérifiez votre adresse e-mail',
      description: 'Bienvenue sur Mushrif! Veuillez vérifier votre adresse e-mail pour compléter votre inscription et déverrouiller toutes les fonctionnalités.',
      buttonText: 'Vérifier l\'email',
      fallbackText: 'Si le bouton ne fonctionne pas, copiez et collez ce lien dans votre navigateur:',
      warningText: '⚠️ Ce lien de vérification expirera dans 24 heures. Si vous n\'avez pas créé ce compte, vous pouvez ignorer cet e-mail en toute sécurité.',
